...
GUI.skin.button.font = pauseMenuFont;
	...
	if(pauseEnabled == true){
		...
		GUI.Box(Rect(Screen.width /2 - 100,Screen.height /2 - 100,250,200), "Menú Principal");
		
		//Make Main Menu button
		if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 - 50,250,50), "Empezar De Nuevo")){
			Application.LoadLevel(mainMenuSceneName);
		}
		
		//Make Change Graphics Quality button
			if(GUI.Button(Rect(Screen.width /2 - 100,Screen.height /2 ,250,50), "Cambiar Gráficos")){
